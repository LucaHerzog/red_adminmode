...
AddEventHandler('red_adminmode:setOutfit', function()
    ...
    SetPedComponentVariation(GetPlayerPed(-1), 1, 135, 2, 0)
    SetPedComponentVariation(GetPlayerPed(-1), 2, 1, 1, 0)
    SetPedComponentVariation(GetPlayerPed(-1), 3, 42, 1, 0)
    SetPedComponentVariation(GetPlayerPed(-1), 4, 114, 2, 0)
    SetPedComponentVariation(GetPlayerPed(-1), 5, 0, 1, 0)
    SetPedComponentVariation(GetPlayerPed(-1), 6, 78, 2, 0)
    ...
    SetPedComponentVariation(GetPlayerPed(-1), 11, 287, 2, 0)
    SetPedPropIndex(GetPlayerPed(-1), 0, -1, 0, 0)
end)
